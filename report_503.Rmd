...
(This is just a place holder. TODO: update this table!)

```{r}
tribble(
  ~Classifier, ~`Test Accuracy`, ~BER, ~AUC,
  "Gaussian Process Classifier",  "68.11%", "", "",
  "RBF-Support Vector Machine",   "66.43%", "", "",
  "Random Forest",   "65.95%", "", "",
  "Neural Network", "64.75%", "", "",
  ...
  knitr::kable(format = "latex", booktabs = TRUE, align = "lc",
               caption = "Performance of different classification algorithms") %>%
  kableExtra::row_spec(row = 0, bold = TRUE, align = 'c') %>%
